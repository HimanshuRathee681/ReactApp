    ...
    return (
        <footer id="footer" className="footer">
            <Container>
                ...
                <Row>
                    <Col>
                        <p className="footer-text">Contact: 9876263991<br />Order: 9876263992, 9876263993, 9876263994 <br />
                            &copy; COPYRIGHT 2021 reserved by 2 Brother Pizza and Burger<br /><br/>
                            Made with <img src={heart} alt="Heart" style={{ height: "22px", padding: "0 3px", float: "none" }} /> from <a style={{ display: "inline", float: "none" }} >Himanshu Rathee</a></p>
                    </Col>
                </Row>
            </Container>
        </footer>
